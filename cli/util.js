...
try {
    ...
    require.resolve("@convoy/protobufjs");
    exports.pathToProtobufJs = "@convoy/protobufjs";
} catch (e) {
...
exports.wrap = function(OUTPUT, options) {
    ...
    wrap = wrap.replace(/\$DEPENDENCY/g, JSON.stringify(options.dependency || exports.pathToProtobufJs));
